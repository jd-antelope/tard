...
import { SlMediaPickerProps, SlMediaPickerState, File } from '../../../types/media'
                    ...
                    >
                      {item.type === 'btn' && (
                        ...
                        >
                          ...
                          <View className='text'>
                            添加{mediaType === 'camera' ? '图片' : '视频'}{ maxCount > 1 && `(${files.length}/${maxCount})`}
                          </View>
...
SlMediaPicker.propTypes = {
  className: PropTypes.oneOfType([PropTypes.string, PropTypes.array]),
  customStyle: PropTypes.oneOfType([PropTypes.string, PropTypes.object]),
  files: PropTypes.array,
  maxDuration: PropTypes.number,
  mediaType: PropTypes.oneOf(['camera', 'video']),
