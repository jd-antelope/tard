...
var SlLoading = function () {
    return (React.createElement(View, { className: "aaa" }, "111"));
};
var index$2 = memo(SlLoading);

var css_248z$1 = "";
styleInject(css_248z$1);

var SlUpload = function () {
    return React.createElement(View, { className: "sl-upload-wrapper" }, "mmm");
};
var index$1 = memo(SlUpload);
...
var SlImage = /** @class */ (function (_super) {
    ...
    SlImage.prototype.render = function () {
        ...
        return (React.createElement(Fragment, null,
            React.createElement(Image, __assign({}, res, { src: url, className: cn(className, {
...
var SlPrice = function () {
    return React.createElement(View, { className: "sl-price-wrapper" }, "this is SlPrice");
};
var index = memo(SlPrice);

export { SlImage, index$2 as SlLoading, index as SlPrice, index$1 as SlUpload };
