...
import { ButtonProps as CButtonProps, ButtonState } from './type'
...
export default class SlButton extends React.Component<CButtonProps, ButtonState> {
  public static defaultProps: ButtonProps
  public static propTypes: InferProps<ButtonProps>

  public constructor(props:CButtonProps) {
    super(props)
    this.state = {
